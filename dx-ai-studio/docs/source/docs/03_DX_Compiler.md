...
2. **Loader Mode** — **Default** (real calibration data) or **Dummy** (random tensors,
   quick check).
3. **Dataset & Preprocessing** — dataset path, file extensions, a preprocessing pipeline
...
!!! note "Related"
    Compiler outputs (`.dxnn`) run in **[DX App](04_DX_App.md)** and
    **[DX Stream](05_DX_Stream.md)**. Source models come from
    **[DX Model Zoo](06_DX_Model_Zoo.md)**.
