    ...
    { id: 'recommendations', icon: '📊',
      ...
      steps: [
        ...
        { target: '#recommendSummary', position: 'bottom',
          ...
          content: { ko: '요구 조건 충족, 부족, 이론 추정 항목 수를 빠르게 확인합니다.', en: 'Quickly see counts for meets, insufficient, and theoretical recommendations.', ja: '充足、不足、理論推定の件数を素早く確認します。', 'zh-CN': '快速查看达标、不足和理论估算数量。', 'zh-TW': '快速查看達標、不足和理論估算數量。', es: 'Consulte rápidamente la cantidad de recomendaciones que cumplen, son insuficientes o son estimaciones teóricas.' } },
    ...
    { id: 'details', icon: '🔍',
      ...
      steps: [
        { target: '#detailPanel', position: 'left',
          ...
          content: { ko: '선택한 추천의 성능, 비용, 전력, 채널 근거를 한 패널에서 계속 비교합니다.', en: 'Keeps performance, cost, power, and channel evidence visible for the selected recommendation.', ja: '選択した推奨の性能、コスト、電力、チャンネル根拠を1つのパネルで比較できます。', 'zh-CN': '在一个面板中持续查看所选推荐的性能、成本、功耗和通道依据。', 'zh-TW': '在一個面板中持續查看所選推薦的效能、成本、功耗和通道依據。', es: 'Mantiene visibles en un solo panel el rendimiento, el costo, el consumo eléctrico y la evidencia de canales de la recomendación seleccionada.' } },
        { target: '#recommendation-facts', position: 'left',
          title: { ko: '핵심 수치', en: 'Key facts', ja: '主要指標', 'zh-CN': '关键指标', 'zh-TW': '關鍵指標', es: 'Métricas clave' },
          content: { ko: '요구 채널, 목표 FPS, 최대 채널, latency, throughput, 비용/채널, TOPS/W를 바로 보여줍니다.', en: 'Shows required channels, target FPS, max channels, latency, throughput, cost/channel, and TOPS/W.', ja: '要求チャンネル、目標FPS、最大チャンネル、latency、throughput、コスト/チャンネル、TOPS/Wを表示します。', 'zh-CN': '显示所需通道、目标FPS、最大通道、latency、throughput、每通道成本和TOPS/W。', 'zh-TW': '顯示所需通道、目標FPS、最大通道、latency、throughput、每通道成本和TOPS/W。', es: 'Muestra directamente los canales requeridos, el FPS objetivo, el máximo de canales, latencia, throughput, costo/canal y TOPS/W.' } },
        { target: '#platform-summary', position: 'left',
          ...
          content: { ko: 'NPU, TOPS, TDP, 가격, DRAM, Host 정보를 요약합니다.', en: 'Summarizes NPU, TOPS, TDP, price, DRAM, and host information.', ja: 'NPU、TOPS、TDP、価格、DRAM、Host情報を要約します。', 'zh-CN': '汇总NPU、TOPS、TDP、价格、DRAM和Host信息。', 'zh-TW': '彙總NPU、TOPS、TDP、價格、DRAM和Host資訊。', es: 'Resume la información de NPU, TOPS, TDP, precio, DRAM y host.' } },
...
var referenceDocs = [
    ...
    { id: 'ref-recommend', icon: '🎯',
      ...
      body: { ko: '<h3>추천 원리</h3><ul><li>선택한 task/size/runtime의 benchmark와 multi-stream 데이터를 사용합니다.</li><li>요구 채널을 충족하는 플랫폼을 먼저 보여줍니다.</li><li>비용, 성능, 전력 우선순위에 따라 정렬이 달라집니다.</li></ul>',
              en: '<h3>How recommendations work</h3><ul><li>Uses benchmark and multi-stream data for the selected task, size, and runtime.</li><li>Platforms meeting required channels are ranked first.</li><li>Sorting changes by cost, performance, or power priority.</li></ul>',
              ja: '<h3>推奨の仕組み</h3><ul><li>選択task、size、runtimeのbenchmarkとmulti-streamデータを使います。</li><li>要求チャンネルを満たすプラットフォームを優先します。</li><li>コスト、性能、電力の優先度で並び順が変わります。</li></ul>',
              'zh-CN': '<h3>推荐原理</h3><ul><li>使用所选task、size、runtime的benchmark和multi-stream数据。</li><li>优先展示满足所需通道的平台。</li><li>排序会随成本、性能或功耗优先级变化。</li></ul>',
              'zh-TW': '<h3>推薦原理</h3><ul><li>使用所選task、size、runtime的benchmark和multi-stream資料。</li><li>優先顯示滿足所需通道的平台。</li><li>排序會隨成本、效能或功耗優先順序變化。</li></ul>',
              es: '<h3>Cómo funcionan las recomendaciones</h3><ul><li>Utiliza datos de benchmark y multi-stream de la task, el size y el runtime seleccionados.</li><li>Las plataformas que cumplen los canales requeridos aparecen primero.</li><li>El orden cambia según la prioridad de costo, rendimiento o consumo eléctrico.</li></ul>' } },
    { id: 'ref-detail', icon: '📈',
      title: { ko: '상세 패널', en: 'Detail panel', ja: '詳細パネル', 'zh-CN': '详情面板', 'zh-TW': '詳情面板', es: 'Panel de detalle' },
